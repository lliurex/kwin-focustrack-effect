...
private:
    ...
    /**
     * \brief Reference to `uniform vec4 focusTrackFilter;`
     *        Containing the filter to apply
     */
    int m_shader_focusTrackFilter = 0;

    /**
     * \brief Reference to `uniform vec4 applyFocusTrack;`
     *        Containing the bool that controls correction of transformed colors
     */
    int m_shader_applyFocusTrack = 0;
